...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cackhoandathanhtoan);
        getID();
        Random r = new Random();
        int id1 = r.nextInt(1000);
        edID.setText(id1 + "");
        sqlHelper = new SQLHelper(MainActivity.this);
        sqlHelper.insertCard(new KhoanDaThanhToan(123, "Kỹ Thuật Lập Trình", "1000000", "07/05/2021", "3", "Kỹ Thuật Lập Trình"));
        sqlHelper.insertCard(new KhoanDaThanhToan(345, "Tiếng Anh CNTT", "2000000", "09/05/2021", "4", "Tiếng Anh CNTT"));
